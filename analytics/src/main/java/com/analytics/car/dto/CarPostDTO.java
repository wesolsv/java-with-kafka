...
public class CarPostDTO {
    ...
    public CarPostDTO(String model, String brand, Double price, String description, String engineVersion,
                      String city, String createdDate, Long ownerId, String ownerName) {
        this.model = model;
        this.brand = brand;
        this.price = price;
